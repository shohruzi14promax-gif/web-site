            ...
            <div className="rounded-[28px] border border-white/70 bg-white/80 p-7 shadow-xl backdrop-blur-xl sm:p-9">
              ...
              <div className="mt-8 border-t border-black/5 pt-7">
                ...
                <div className="mt-4 grid gap-3 sm:grid-cols-2">
                  {['Amaliy mashg‘ulotlar', 'Fan olimpiadalariga tayyorgarlik', 'Loyiha va tadqiqot ishlari', 'Qo‘shimcha o‘quv materiallari'].map((item) => <div key={item} className="rounded-xl bg-[#f5f5f7] px-4 py-3 text-sm text-[#6e6e73]">✓ {item}</div>)}
                </div>
              </div>
